...
class ConfigurationService extends BaseTmdbService {
  ...
  Future<TmdbApiConfigDetails> getDetails({
  ...
  Future<List<TmdbCountry>> getCountries({
    Map<String, String>? queryParameters,
  }) async {
    final jsonResponse = await get(
  ...
  Future<List<TmdbLanguage>> getLanguages({
    Map<String, String>? queryParameters,
  }) async {
    final jsonResponse = await get(
  ...
  Future<List<String>> getPrimaryTranslations({
    Map<String, String>? queryParameters,
  }) async {
    final jsonResponse = await get(
  ...
  Future<List<TmdbTimezone>> getTimezones({
    Map<String, String>? queryParameters,
  }) async {
    final jsonResponse = await get(
