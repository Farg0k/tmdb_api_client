...
class TmdbApiException implements Exception {
  ...
  final int
  statusCode; // The HTTP status code returned by the API (e.g., 401, 404).
  ...
  @override
  String toString() =>
      'TmdbApiException: $message (Status: $statusCode, Code: ${errorCode ?? 'N/A'})';
}
...
class TmdbNetworkException implements Exception {
  final String
  message; // A human-readable error message describing the network issue.
