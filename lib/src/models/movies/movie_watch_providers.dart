...
/// [CountryWatchProviders] contains available providers for a specific country.
...
class MovieWatchProvidersResponse {
  ...
  MovieWatchProvidersResponse({required this.id, required this.results});

  factory MovieWatchProvidersResponse.fromJson(Map<String, dynamic> json) {
    ...
    return MovieWatchProvidersResponse(id: json['id'] as int, results: mappedResults);
  }
}
